                ...
                <div class="modal-content">
                    <div class="modal-header d-flex justify-content-between align-items-start" style="background-color: #181a46; color: white;">
                        <div class="subject-info">
                            <h5 class="modal-title" id="tadiModalLabel1">John Pasis</h5>
                            <p class="subject-details mb-0">Section: BSCS4A</p>
                        </div>
                    </div>
                    ...
                    <div class="row mt-4">
                        <div class="col">
                            ...
                            <label for="subject" class="form-label">Filipino</label>
                    
                        </div>
                        <div class="row mt-2">
                            <div class="col-md-6">
                            <label for="courseCode" class="form-label fw-bold">Course Code:</label>
                            <label for="courseCode" class="form-label">OOP_1</label>

                                <label for="coursemode" class="form-label fw-bold">Mode of Class:</label>
                                <label for="coursemode" class="form-label">Face to Face</label>
                            </div>

                            <div class="row mt-3">
                                <div class="col-md-2">
                                    <label for="timeStart" class="form-label fw-bold ">Time Start:</label>
                                    <label for="timeStart" class="form-label">1:00 PM</label>
                                </div>
                                <div class="col-md-3">
                                    <label for="timeEnd" class="form-label fw-bold ">Time End:</label>
                                    <label for="timeEnd" class="form-label ">4:00 PM</label>
