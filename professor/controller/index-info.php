<?php 
    ...
    if($_GET['type'] == 'GET_SUBJECT_LIST'){
        ...
        $qry = "   SELECT 
                ...
                WHERE
                    `schl_enr_subj_off`.`SchlAcadLvl_ID` =  $LVLID 
                    AND `schl_enr_subj_off`.`SchlAcadYr_ID` = $YRID 
                    AND `schl_enr_subj_off`.`SchlAcadPrd_ID` = $PRDID
                    AND `schl_enr_subj_off`.`SchlProf_ID` = $USERID
                    AND `schl_enr_subj_off`.`SchlEnrollSubjOff_ISACTIVE` =  $SUBACT";
